...
public class PinkFragment extends Fragment {
    ...
    private listenerOnClickHint mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button button = v.findViewById(R.id.btPink);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof listenerOnClickHint) {
            mListener = (listenerOnClickHint) context;
        } else {
            throw new RuntimeException(context.toString()
                    + " must implement listenerOnClickHint");
        }
    }
